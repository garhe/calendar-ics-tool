...
const translations = {
  'zh-CN': {
    ...
    'UTC+7 or city name': 'UTC+7 或城市名称', "Tom's birthday every year on Jun 5": '汤姆的生日，每年 6 月 5 日',
    'MM/DD/YYYY': 'YYYY/MM/DD',
    'Design Review | 2026-05-20 14:00-15:00 | Teams | Q3 roadmap | Europe/Paris\nAF 1290 Paris → Catania, 28 Aug 2026, 09:20 to 12:05': '设计评审 | 2026-05-20 14:00-15:00 | Teams | 第三季度路线图 | Europe/Paris\nAF 1290 巴黎 → 卡塔尼亚 | 2026-08-28 09:20-12:05 | 巴黎 | 航班 | Europe/Paris',
    ...
    'Enter an event title and lunar date as {format}.': '请输入日程标题和 {format} 格式的农历日期。',
    'The lunar calendar library did not load. Check your internet connection and reload.': '农历库加载失败。请检查网络连接并重新加载。',
    'Enter a valid lunar event date as {format}.': '请输入有效的 {format} 格式农历日期。',
  ...
  vi: {
    ...
    'Design Review | 2026-05-20 14:00-15:00 | Teams | Q3 roadmap | Europe/Paris\nAF 1290 Paris → Catania, 28 Aug 2026, 09:20 to 12:05': 'Đánh giá thiết kế | 2026-05-20 14:00-15:00 | Teams | Lộ trình quý 3 | Europe/Paris\nAF 1290 Paris → Catania | 2026-08-28 09:20-12:05 | Paris | Chuyến bay | Europe/Paris',
    ...
    'Enter an event title and lunar date as {format}.': 'Nhập tên sự kiện và ngày âm lịch theo định dạng {format}.',
    ...
    'Enter a valid lunar event date as {format}.': 'Nhập ngày âm lịch hợp lệ theo định dạng {format}.',
